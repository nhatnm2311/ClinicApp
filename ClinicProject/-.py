...
logging.warning(DEFAULT_DEPRECATION_MESSAGE.format(DEFAULT_VERSION))
...
def _install(archive_filename, install_args=()):
    ...
    with archive_context(archive_filename):
        # installing
        logging.warning('Installing Setuptools')
...
def _build_egg(egg, archive_filename, to_dir):
    ...
    with archive_context(archive_filename):
        # building an egg
        logging.warning('Building a Setuptools egg in %s', to_dir)
